...
// ============================================================================
// DESTINATION HANDLERS  (unchanged from v0.3 except openSocket replaces startPolling)
// ============================================================================

/**
 * sendToReminders:
 *   - Claude selected  → POST /reminder → WebSocket push for ready/tool_failed
...
function handleUserMessage(text) {
  ...
  Pebble.getTimelineToken(function (token) {
    ...
    .then(function (data) {
      if (!data || !data.jobId) {
        inflight = false; conversation.pop(); chunker.sendErrorCode(7); return;
      }
